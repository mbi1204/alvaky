 ...
 * Descripcion: Genera las consultas sobre las tiendas y su historial de
 * reportes ejecutivos de 6 meses atras dependiendo de la fecha actual
 */
			...
			if (data !== "") {
				...
				for ( var item in data) {
					$("#mytable > tbody").append(
							'<tr ondblclick="abrir_VenReporte('
									+ data[item].cSucursal + ');">' + '<td>'
									+ data[item].cSucursal + '</td>' + '<td>'
									+ data[item].cNombre + '</td>' +
									/*
									 * '<td><nobr>'
									 *  + '<a class="pure-button
									 * pure-button-primary"' + 'onclick="return
